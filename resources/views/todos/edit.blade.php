                    ...
                    <form action="{{ route('todos.update', $todo->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-left my-4">
                            ...
                            <input type="text" name="name"
                                class="w-full bg-slate-100 rounded-md p-2 border @error('name') border-red-400 @enderror"
                        ...
                        <div class="text-left my-4">
                            ...
                            <textarea name="detail" rows="8"
                                class="w-full bg-slate-100 rounded-md p-2 border @error('detail') border-red-400 @enderror">{{ old('detail', $todo->detail) }}</textarea>
                            @error('detail')
                                <div class="text-sm text-red-500">*{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <button type="submit"
                                class="mt-3 btn btn-primary font-bold bg-green-500 text-white px-4 py-2 rounded-md">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
